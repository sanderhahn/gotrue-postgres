...
--
-- Name: audit_log_entries idx_16387_primary; Type: CONSTRAINT; Schema: gotrue; Owner: gotrue
--
...
--
-- Name: instances idx_16393_primary; Type: CONSTRAINT; Schema: gotrue; Owner: gotrue
--
...
--
-- Name: refresh_tokens idx_16401_primary; Type: CONSTRAINT; Schema: gotrue; Owner: gotrue
--
...
--
-- Name: users idx_16411_primary; Type: CONSTRAINT; Schema: gotrue; Owner: gotrue
--
...
--
-- Name: idx_16387_audit_logs_instance_id_idx; Type: INDEX; Schema: gotrue; Owner: gotrue
--

CREATE INDEX idx_16387_audit_logs_instance_id_idx ON gotrue.audit_log_entries USING btree (instance_id);


--
-- Name: idx_16401_refresh_tokens_instance_id_idx; Type: INDEX; Schema: gotrue; Owner: gotrue
--

CREATE INDEX idx_16401_refresh_tokens_instance_id_idx ON gotrue.refresh_tokens USING btree (instance_id);


--
-- Name: idx_16401_refresh_tokens_instance_id_user_id_idx; Type: INDEX; Schema: gotrue; Owner: gotrue
--

CREATE INDEX idx_16401_refresh_tokens_instance_id_user_id_idx ON gotrue.refresh_tokens USING btree (instance_id, user_id);


--
-- Name: idx_16401_refresh_tokens_token_idx; Type: INDEX; Schema: gotrue; Owner: gotrue
--

CREATE INDEX idx_16401_refresh_tokens_token_idx ON gotrue.refresh_tokens USING btree (token);


--
-- Name: idx_16408_schema_migration_version_idx; Type: INDEX; Schema: gotrue; Owner: gotrue
--

CREATE UNIQUE INDEX idx_16408_schema_migration_version_idx ON gotrue.schema_migration USING btree (version);


--
-- Name: idx_16411_users_instance_id_email_idx; Type: INDEX; Schema: gotrue; Owner: gotrue
--

CREATE INDEX idx_16411_users_instance_id_email_idx ON gotrue.users USING btree (instance_id, email);


--
-- Name: idx_16411_users_instance_id_idx; Type: INDEX; Schema: gotrue; Owner: gotrue
--

CREATE INDEX idx_16411_users_instance_id_idx ON gotrue.users USING btree (instance_id);
